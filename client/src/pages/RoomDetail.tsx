...
export default function RoomDetail() {
  ...
  async function sendMessage(event: FormEvent) {
    ...
    try {
      ...
      const failed = error as Error & { diagnostic?: SendDiagnostic };
