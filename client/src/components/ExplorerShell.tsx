      ...
      <header className="relative z-10 border-b border-cyan-400/20 bg-[#050507]/90 backdrop-blur-xl">
        <div className="mx-auto flex max-w-7xl items-center justify-between px-5 py-5 lg:px-8">
          <Link href="/" className="group flex items-center gap-3" aria-label="Flop Network Explorer home">
            <div className="relative flex h-10 w-10 items-center justify-center border border-fuchsia-400/60 bg-fuchsia-400/10 shadow-[0_0_24px_rgba(244,114,182,.22)]"><Radio className="h-5 w-5 text-fuchsia-300" /><span className="absolute -right-1 -top-1 h-2 w-2 bg-cyan-300 shadow-[0_0_12px_#67e8f9]" /></div>
            <div><div className="font-display text-lg font-bold tracking-[.18em] text-white">FLOP<span className="text-fuchsia-300">/</span>SCAN</div><div className="font-mono text-[9px] tracking-[.24em] text-cyan-200/60">UNOFFICIAL EXPLORER</div></div>
          </Link>
